...
<table>
    ...
    <tr>
        ...
        <td>
            ...
            <br />
            <br />
            e.g.: If the validation fails we can cancel form submitting and can show an error message. Please see the 校验 example for the implementation
            <br />
            <br />
